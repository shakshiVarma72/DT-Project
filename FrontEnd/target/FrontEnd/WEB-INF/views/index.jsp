...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="${images}/slider11.jpg" alt="Flat 50% off" style="width:50px height:5px;">
      </div>

      <div class="item">
        <img src=".jpg" alt="slider12.jpg" style="width:100% height=50%;">
      </div>
    
      <div class="item">
        <img src=".jpg" alt="slider13.jpg" style="width:100% height=50%;">
      </div>
    </div>
