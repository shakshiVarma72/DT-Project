...
<body>
	...
	<div class="container">
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item">
					<img src="${images}/slider53.jpg" style="width: 100%;">
				</div>
			</div>
	...
	" class="btn btn-warning"><i class="fa fa-shopping-cart">Add Cart</i>
							</a>
